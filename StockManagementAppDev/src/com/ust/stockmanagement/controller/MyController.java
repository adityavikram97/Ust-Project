...
public class MyController {
	...
	public ModelAndView addproduct(){
		if(h.getAttribute("email")!=null) {
		return new ModelAndView("productReg");
		}else{
			return new ModelAndView("login","msg2","Login First.. User is not loggged in ");
		}
	}
